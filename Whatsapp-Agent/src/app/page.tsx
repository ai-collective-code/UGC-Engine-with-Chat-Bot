...
// Must match REALTIME_CHANNEL in src/lib/realtime.ts
const REALTIME_CHANNEL = "whatsapp-dashboard";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    (async () => {
      // Only open a realtime connection if the server has Ably configured.
      // /api/ably-token returns 503 when ABLY_API_KEY is unset.
      try {
      ...
      const channel = client.channels.get(REALTIME_CHANNEL);
      ...
      channel.subscribe("conversation:changed", () => fetchConversations());
    })();
